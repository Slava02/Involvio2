...
class UserRequestResponseBody(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["$schema", "birthday", "city", "full_name", "gender", "goal", "groups", "id", "interests", "photo_url", "position", "socials", "user_name"]
