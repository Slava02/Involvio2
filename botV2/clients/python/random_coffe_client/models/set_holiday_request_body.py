...
class SetHolidayRequestBody(BaseModel):
    """
    ...
    till_date: datetime = Field(description="When holiday ends RFC 3339")
    __properties: ClassVar[List[str]] = ["$schema", "id", "till_date"]
