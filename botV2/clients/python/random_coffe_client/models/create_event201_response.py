...
class CreateEvent201Response(BaseModel):
    """
    CreateEvent201Response
    """ # noqa: E501
    var_date: datetime = Field(description="event time RFC 3339", alias="date")
    description: StrictStr = Field(description="event description")
    id: StrictInt = Field(description="event id")
    name: StrictStr = Field(description="event name")
    users: Optional[List[User]] = Field(description="event members")
    __properties: ClassVar[List[str]] = ["date", "description", "id", "name", "users"]
