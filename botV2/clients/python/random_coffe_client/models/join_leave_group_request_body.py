...
class JoinLeaveGroupRequestBody(BaseModel):
    """
    ...
    group_name: StrictStr = Field(description="Group UserID")
    user_id: StrictInt = Field(description="Group UserID")
    __properties: ClassVar[List[str]] = ["$schema", "group_name", "user_id"]
